	...
	<?php if($query->have_posts()){ ?>
		<div class="testimonial-collection testimonial-<?php echo esc_attr($skin); ?>">
			...
			<div id="carousel-<?php echo esc_attr($_id); ?>" class="owl-carousel-play" data-ride="owlcarousel">
				<div class="opallisting-carousel owl-carousel" data-items="<?php echo esc_attr($columns); ?>" data-slide="<?php echo esc_attr($columns); ?>" data-pagination="true" data-navigation="false">
